...
} from '@gateway_procurement/purchase_order/dto/purchase.order'
import { PurchaseOrderApprovalDTO } from '@gateway_procurement/purchase_order/dto/purchase.order.approval'
