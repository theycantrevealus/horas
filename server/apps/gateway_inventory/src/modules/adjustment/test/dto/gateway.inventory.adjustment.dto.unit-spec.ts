...
} from '@gateway_inventory/adjustment/dto/adjustment'
import { StockAdjustmentApprovalDTO } from '@gateway_inventory/adjustment/dto/adjustment.approval'
...
const falseCasePayload = {
  add: [
    {
      ...
      targetClass: StockAdjustmentAddDTO,
      testType: -1,
      data: {
  ...
  edit: [
    {
      expectedToContain: 'code must be longer than or equal to 8 characters',
      targetClass: StockAdjustmentEditDTO,
      testType: -1,
      data: {
        code: faker.string.alpha({ length: 5, casing: 'upper' }),
        stock_point: {
  ...
  approval: [
    {
      ...
      targetClass: StockAdjustmentApprovalDTO,
      testType: -1,
      data: {
        remark: '',
        __v: 0,
...
describe('Stock Adjustment DTO Test', () => {
  describe(testCaption('ADD', 'data', 'Stock Adjustment Add'), () => {
  ...
  describe(testCaption('EDIT', 'data', 'Stock Adjustment Edit'), () => {
  ...
  describe(testCaption('APPROVAL', 'data', 'Stock Adjustment Approval'), () => {
