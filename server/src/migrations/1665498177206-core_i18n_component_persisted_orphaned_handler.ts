...
export class coreI18nComponentPersistedOrphanedHandler1665498177206 implements MigrationInterface {
    name = 'coreI18nComponentPersistedOrphanedHandler1665498177206'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "core_i18n_component" ADD CONSTRAINT "FK_ef3eb2e0695e15272be2d484756" FOREIGN KEY ("menu_id") REFERENCES "core_menu"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }
