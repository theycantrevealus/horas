<template>
  <div class="grid">
    <div class="col-12">
      <Card class="slim">
        <template #content>
          <Panel header="i18n Management" :toggleable="false">
            <template #icons>
              <Button
                type="button"
          ...
          <div class="p-grid">
            <div class="p-col-12">
              <div class="flex jc-between">
                <div
                  class="flex-initial flex align-items-center justify-content-center m-2 px-5 py-3"
                >
                  <Button
                    type="button"
                ...
                <div
                  class="flex-grow-1 flex align-items-center justify-content-center m-2 px-5 py-3"
                ></div>
                <div
...
export default defineComponent({
  ...
  methods: {
    ...
    async duplicateComponent() {
      await this.$store.dispatch('corei18N/fetchi18nDetail', 9).then((duplicateData) => {
        //
      })
    },
