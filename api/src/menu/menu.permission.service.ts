...
import { MenuPermissionAddDTO, MenuPermissionAddResponseDTO } from './dto/menu.permission.add.dto'
import { MenuPermissionDeleteResponseDTO } from './dto/menu.permission.delete.dto'
import { MenuPermissionEditDTO, MenuPermissionEditResponseDTO } from './dto/menu.permission.edit.dto'
...
export class MenuPermissionService {
    ...
    async add (data: MenuPermissionAddDTO) {
        ...
        const menuRes = await this.menuPermissionRepo.save(data).then(async returning => {
    ...
    async edit (data: MenuPermissionEditDTO, id: number) {
        ...
        const menuRes = await this.menuPermissionRepo.update(id, data).then(async returning => {
