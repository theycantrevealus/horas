<template>
  <div>
    <form
      autocomplete="off"
      @submit.prevent="submitItemBrand"
    >
      <Card>
        <template #content>
...
export default {
  ...
  mounted() {
    if(this.dialogRef.data.mode === 'edit') {
      MasterItemBrandService.getItemBrandDetail(this.dialogRef.data.id).then((response) => {
  ...
  methods: {
    ...
    async submitData() {
      if(this.dialogRef.data.mode === 'edit') {
        await MasterItemBrandService.editItemBrand(this.dialogRef.data.id, {
          code: this.code,
          name: this.name,
          remark: this.remark
        }).then(() => {
        ...
        await MasterItemBrandService.addItemBrand({
          code: this.code,
          name: this.name,
          remark: this.remark
        }).then(() => {
