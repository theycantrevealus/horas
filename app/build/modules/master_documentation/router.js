const moduleRoute = [
    {
        ...
        component: () => import(
        /* webpackChunkName: "master_documentation" */ '@/modules/master_documentation/Module.vue'),
        meta: {
        ...
        children: [
            {
                ...
                component: () => import(
                /* webpackChunkName: "master_documentation" */ '@/modules/master_documentation/views/Index.vue'),
            },
            {
                path: 'add',
                ...
                component: () => import(
                /* webpackChunkName: "master_documentation" */ '@/modules/master_documentation/views/Add.vue'),
            },
            {
                path: 'edit/:id',
                ...
                component: () => import(
                /* webpackChunkName: "master_documentation" */ '@/modules/master_documentation/views/Edit.vue'),
            },
        ],
    },
];
